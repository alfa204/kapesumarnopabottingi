...
public class BasicOpenARDemoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // We hook up 4 different buttons.
    ...
    private void addPois(WikitudeARIntent intent) {
        ...
        WikitudePOI poi1 = new WikitudePOI(-6.882225, 107.611724, 10, "Cisitu GH", "Cisitu Guest House.");
        poi1.setDetailAction(BasicOpenARDemoActivity.CALLBACK_INTENT);
        //WikitudePOI poi2 = new WikitudePOI(41.9, 12.5, 14, "Rome", "Rome is the capital of Italy and the country's largest and most populous city, with over 2.7 million residents.");
        WikitudePOI poi2 = new WikitudePOI(-6.891492, 107.610004, 10, "ITB", "Institut Teknologi Bandung.");
        poi2.setDetailAction(BasicOpenARDemoActivity.CALLBACK_INTENT);
        //WikitudePOI poi3 = new WikitudePOI(40.716667, -74, 1, "New York", "New York is the most populous city in the United States, and the center of the New York metropolitan area.");
        WikitudePOI poi3 = new WikitudePOI(-6.894783, 107.604366, 10, "CiWalk", "Cihampelas Walk.");
        poi3.setDetailAction(BasicOpenARDemoActivity.CALLBACK_INTENT);
        //WikitudePOI poi4 = new WikitudePOI(48.208333, 16.373056, 220, "Vienna", "Vienna is the capital of the Republic of Austria.");
        WikitudePOI poi4 = new WikitudePOI(-6.889447, 107.613459, 10, "St.Boromeus", "Rumah Sakit Santo Boromeus.");
    ...
    private void addIcons(WikitudeARIntent intent) {
        ...
        /*pois.get(0).setIconuri("content://com.IconCP/sdcard/flag_japan.png");
        pois.get(1).setIconuri("content://com.IconCP/sdcard/flag_italy.png");
        pois.get(2).setIconuri("content://com.IconCP/sdcard/flag_usa.png");
        pois.get(3).setIconuri("content://com.IconCP/sdcard/flag_austria.png");*/
    }
