...
--
-- Host: localhost
-- Generation Time: Jul 01, 2011 at 05:02 PM
...
CREATE TABLE IF NOT EXISTS `poilayar_table` (
  ...
  `imageWiki` varchar(255) DEFAULT NULL,
...
INSERT INTO `poilayar_table` (`id`, `tagline`, `title`, `lat`, `lon`, `imageURL`, `baseURL`, `imageFull`, `imageReduced`, `imageIcon`, `imageWiki`, `size`, `line4`, `line3`, `line2`, `type`, `dimension`, `alt`, `relativeAlt`, `distance`, `inFocus`, `doNotIndex`, `showSmallBiw`, `showBiwOnClick`, `kategori`, `deskripsi`, `rel`, `angle`, `scale`) VALUES
