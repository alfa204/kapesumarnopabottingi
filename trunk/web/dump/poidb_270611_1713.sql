...
--
-- Host: localhost
-- Generation Time: Jun 27, 2011 at 06:13 PM
...
INSERT INTO `dynamictext_table` (`id`, `poi_id`, `text`, `start_date`, `end_date`, `isapproved`) VALUES
...
INSERT INTO `poiapproval_table` (`id`, `userid`, `title`, `lat`, `lon`, `imageURL`, `address`, `phone`, `email`, `tagline`, `image_full`, `image_reduced`, `image_icon`, `image_wiki`, `deskripsi`, `kategori`, `status`, `message`) VALUES
(1, 3, 'Meja Saya', '-6.1923810000', '106.8376750000', 'Layar_banner_icon.png', 'Jl Cikini Raya 5 No. 12, Jakarta Pusat', '+62887881781', 'the.end.4ever@gmail.com', NULL, 'Layar_banner_icon.png', NULL, NULL, '', NULL, '1', '3', NULL);
...
INSERT INTO `poi_table` (`id`, `userid`, `attribution`, `title`, `lat`, `lon`, `imageURL`, `line4`, `line3`, `line2`, `type`, `dimension`, `alt`, `relativeAlt`, `distance`, `inFocus`, `doNotIndex`, `showSmallBiw`, `showBiwOnClick`, `kategori`, `deskripsi`) VALUES
