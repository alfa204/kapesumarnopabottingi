...
--
-- Host: localhost
-- Generation Time: Jul 07, 2011 at 10:52 AM
...
INSERT INTO `poilayar_table` (`id`, `userid`, `attribution`, `title`, `lat`, `lon`, `imageURL`, `line4`, `line3`, `line2`, `type`, `dimension`, `alt`, `relativeAlt`, `distance`, `inFocus`, `doNotIndex`, `showSmallBiw`, `showBiwOnClick`, `kategori`, `deskripsi`) VALUES
...
(6, 1, 'Rumah Pudy', '-6.2033600000', '106.8457600000', '', '', '', '', 'train_256x256.png', '', '', '', '', '1', 1, NULL);
